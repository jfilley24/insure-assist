...
## 6. Question vs. Execution Protocol ("Discuss First, Code Later")
...
If the user throws out random thoughts or links (like referencing a Google Forum post about a bug), **discuss the findings and mutually agree on an approach FIRST**. Explain what you found and what you plan to change *before* writing any scripts or pushing files. Communication is prioritized over blind velocity.
