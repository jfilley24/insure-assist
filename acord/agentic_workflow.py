...
def process_coi_request(request_pdf_path: str, client_name: str):
    ...
    if review.passed:
        ...
        print("COI generation failed review. Pdf not included in response folder.")

if __name__ == "__main__":
    # Test 1: PEKIN with Agua Caliente
    request_pdf = os.path.join("assets", "Request for COI", "Agua Caliente updated Ins Cert needed.pdf")
